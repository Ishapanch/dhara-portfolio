                            ...
                            <ul>
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <div className="details">
                                            <div className="extra">
                                                <div className="short">
                                                    <p className="date">By <a href="#">Alex Watson</a> <span>22 Oct
                                                            2022</span></p>
                                                </div>
                                            </div>
                                            <h3 className="title"><a href="#">Format releases a new tool that enables direct
                                                    video hosting</a></h3>
                                        ...
                                        <div className="main_content">
                                            <div className="descriptions">
                                                <p className="bigger">Just because we can't get out and about like we
                                ...
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <div className="details">
                                            <div className="extra">
                                                <div className="short">
                                                    <p className="date">By <a href="#">Brook Kennedy</a> <span>15 Oct
                                                            2022</span></p>
                                                </div>
                                            </div>
                                            <h3 className="title"><a href="#">Sony announced two new full frame cameras with
                                                    zero fanfare</a></h3>
                                            <div className="tokyo_tm_read_more">
                                                <a href="#"><span>Read More</span></a>
                                            </div>
                                ...
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <div className="details">
                                            <div className="extra">
                                                <div className="short">
                                                    <p className="date">By <a href="#">Paola Atkins</a> <span>07 Oct
                                                            2022</span></p>
                                                </div>
                                            </div>
                                            <h3 className="title"><a href="#">Why every photographer should shoot film, even
                                                    in 2022</a></h3>
                                            <div className="tokyo_tm_read_more">
                                                <a href="#"><span>Read More</span></a>
                                            </div>
                                ...
                                <li>
                                    <div className="list_inner">
                                        <div className="image">
                                            <img src="img/thumbs/40-25.jpg" alt />
                                            <div className="main" data-img-url="img/news/4.jpg"></div>
                                            <a className="tokyo_tm_full_link" href="#"></a>
                                        </div>
                                        <div className="details">
                                            <div className="extra">
                                                <div className="short">
                                                    <p className="date">By <a href="#">Kevin Stone</a> <span>25 Sep
                                                            2022</span></p>
                                                </div>
                                            </div>
                                            <h3 className="title"><a href="#">Stay creative in lockdown with these fun photo
                                                    projects</a></h3>
                                            <div className="tokyo_tm_read_more">
                                                <a href="#"><span>Read More</span></a>
                                            </div>
